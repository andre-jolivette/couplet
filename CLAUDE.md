...
| 77 | B&W aesthetic suppression + contrast ceiling recalibration | Done. B&W pairs: harmony and contrast multiplied by 0.35 at score time. `paletteContrastScore()` divisor changed from `/80` to `/100`. Requires re-score. See decision #77. |
